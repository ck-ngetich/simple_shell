...
/**
 * cd_to - a function that changes to a directory instructed
 * @datash: other directories
 * Return: nothing
 */
...
/**
 * cd_previous - function that changes directory to previous one
 * @datash: present environ
...
/**
 * cd_to_home - function that changes dir to home dir
 * @datash: present environ
 * Return: nothing
 */
